...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/data/rizwan_karim/vertex_lang-chain/aiml-365220-7d5d084cd436.json"
...
#     app.run(host='172.16.14.213', debug=True, port=1342)
